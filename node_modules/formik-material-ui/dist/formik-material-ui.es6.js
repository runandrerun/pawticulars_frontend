...
var TextField = function (_a) {
    ...
    return (createElement(MuiTextField, __assign({}, props, field, { error: touched[name] && !!errors[name], helperText: touched[name] && errors[name] ? errors[name] : props.helperText, disabled: isSubmitting || disabled })));
};
...
var Switch = function (_a) {
    ...
    return (createElement(MuiSwitch, __assign({ disabled: isSubmitting || disabled }, props, field, { value: field.value ? 'checked' : '' })));
};
Switch.displayName = 'FormikMaterialUISwitch';

var Checkbox = function (_a) {
    var field = _a.field, isSubmitting = _a.form.isSubmitting, _b = _a.disabled, disabled = _b === void 0 ? false : _b, props = __rest(_a, ["field", "form", "disabled"]);
    return (createElement(MuiCheckbox, __assign({ disabled: isSubmitting || disabled }, props, field, { value: field.value ? 'checked' : '' })));
};
Checkbox.displayName = 'FormikMaterialUICheckbox';

var Select = function (_a) {
    var field = _a.field, isSubmitting = _a.form.isSubmitting, _b = _a.disabled, disabled = _b === void 0 ? false : _b, props = __rest(_a, ["field", "form", "disabled"]);
    return createElement(MuiSelect, __assign({ disabled: isSubmitting || disabled }, props, field));
};
